...
export class AddBusinessRegistrationDefaultInvitationToken1755391379448 implements MigrationInterface {
    name = 'AddBusinessRegistrationDefaultInvitationToken1755391379448'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`businesses\` CHANGE \`invitationToken\` \`invitationToken\` varchar(255) NOT NULL DEFAULT ''`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`businesses\` CHANGE \`invitationToken\` \`invitationToken\` varchar(255) NOT NULL`);
